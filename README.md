...
- `create_stress_data()` creates adversarial payment conditions.
- `calculate_correlated_failures()` identifies overlapping errors across models.
- `calculate_calibration()` checks whether model confidence is reliable.
- `calculate_prism_trust_score()` converts the combined signals into a trust score.
...
```text
GET /dashboard
GET /stress-test?stress_level=<number>
GET /red-team
